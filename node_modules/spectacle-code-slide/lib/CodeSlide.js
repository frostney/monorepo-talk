...
var addRanges = require('./addRanges');
...
var CodeSlide = function (_React$Component) {
  ...
  _createClass(CodeSlide, [{
    ...
    value: function render() {
      ...
      var range = ranges[active] || {};
      var loc = range.loc || [];
      var highlights = range.highlights;
      var slideBg = bgColor || defaultBgColor;

      style.color = color || style.color;

      var lines = getHighlightedCodeLines(code, lang);
      if (highlights) lines = addRanges(lines, highlights);
...
CodeSlide.propTypes = {
  ...
  ranges: PropTypes.arrayOf(PropTypes.shape({
    ...
    highlights: PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.number))),
