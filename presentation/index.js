  ...
  render() {
    return (
      <Deck transition={["slide"]} progress="number" transitionDuration={500} theme={theme}>
          ...
          <Image src={images.title} />
            <Layout>
              <Fill>
                ...
                <Text textColor="secondary" style={{ fontSize: "1.75rem" }}>Technical Lead at Gamesys</Text>
              </Fill>
              <Fill>
        ...
        <Slide bgColor="primary">
          <Heading size={3} textColor="secondary">
            Centralised build system
          </Heading>
        </Slide>
        <Slide>
          <Heading size={4} textColor="secondary" style={{ paddingBottom: 40 }}>
            Single build configuration for library-focused monorepos
          </Heading>
        </Slide>
        <Slide>
          <Heading size={4} textColor="secondary" style={{ paddingBottom: 40 }}>
            Source-focused libraries for application-focused monorepos
          </Heading>
        </Slide>
        <Slide bgColor="primary">
          <Heading size={3} textColor="secondary">
            Easy to integrate Semantic Versioning
          </Heading>
        </Slide>
        <Slide bgColor="primary">
          <Heading size={3} textColor="secondary">
      ...
      <Slide bgColor="primary">
        ...
        <Slide>
            ...
            <Text>
              <Link textColor="secondary" href="http://frostney.github.io/monorepo-talk">http://frostney.github.io/monorepo-talk</Link>
            </Text>
            </Heading>
            <Layout>
              <Fill>
